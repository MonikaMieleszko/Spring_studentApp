...
public class StudentController {
    ...
    //model - kontener, do którego możemy zapakowac obiekt i przekazać do widoku
    @GetMapping("/students")
    ...
    //pozwala na zapisywanie wyedytowanego rekordu
    //musimy przygotować to co wyślemy na adres url, w pliku editPerson dodajemy "name", żeby program mógł sparować
    // wprowadzoną wartość z kluczem
